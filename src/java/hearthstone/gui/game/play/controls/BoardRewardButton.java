...
public class BoardRewardButton extends ImageButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawImage(progressMana.getScaledInstance(
                SizeConfigs.progressManaWidth, SizeConfigs.progressManaHeight,
                Image.SCALE_SMOOTH),
                width - SizeConfigs.progressManaWidth, 10,
                SizeConfigs.progressManaWidth, SizeConfigs.progressManaHeight,
                null);
    ...
    private void drawProgressMana(Graphics2D g, FontMetrics fontMetrics){
        ...
        int progressMidX = width - SizeConfigs.progressManaWidth / 2;
        int progressY = 37;
        int textWidth;
