...
public class BoardHeroButton extends ImageButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawImage(healthBackground.getScaledInstance(BoardDefault.healthWidth, BoardDefault.healthHeight,
                Image.SCALE_SMOOTH), midWidth - BoardDefault.healthWidth / 2 + 5, height - 147,
