...
public class HeroButton extends ImageButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawImage(heroImage.getScaledInstance(width - 20,
                height - GUIConfigs.bigHeroDetailHeight,
                Image.SCALE_SMOOTH), 0, 0,
                width - 20, height - GUIConfigs.bigHeroDetailHeight,
                null);

        g2.drawImage(detailsImage.getScaledInstance(GUIConfigs.bigHeroDetailWidth - 4,
                GUIConfigs.bigHeroDetailHeight, Image.SCALE_SMOOTH),
                15, height - GUIConfigs.bigHeroDetailHeight - 50,
