...
public class RankingUpdater implements UpdateWaiter{
    private ClientHandler clientHandler;
    private UpdateWaiter.UpdaterType updaterType;
    private String username;

    public RankingUpdater(String username, UpdateWaiter.UpdaterType updaterType, ClientHandler clientHandler) {
    ...
    @Override
    public void update() {
        HSServer.getInstance().updateRanking(clientHandler);
    }
}
